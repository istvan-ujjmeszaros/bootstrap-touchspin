    ...
    return this.each(function () {
      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          var html_vertical;
          html_vertical = `<span class="input-group-btn-vertical"><button class="${settings.buttondown_class} bootstrap-touchspin-up ${settings.verticalupclass}" type="button">${settings.verticalup}</button><button class="${settings.buttonup_class} bootstrap-touchspin-down ${settings.verticaldownclass}" type="button">${settings.verticaldown}</button></span>`;
          html = `<div class="input-group ${inputGroupSize} bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix"><span class="input-group-text">${settings.prefix}</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">${settings.postfix}</span></span>${html_vertical}</div>`;
        } else {
